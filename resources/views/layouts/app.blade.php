...
<head>
    ...
    <style>
        ...
        .navbar {
            /* Navbar menggunakan abu-abu gelap */
        ...
        /* Penyesuaian tombol agar teks mengikuti tema abu-abu */
        .text-primary {
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menu">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                @else
                    {{-- Tombol login sekarang mengikuti tema abu-abu karena class text-primary sudah kita override --}}
